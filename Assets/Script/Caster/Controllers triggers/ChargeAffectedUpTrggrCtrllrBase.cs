...
public class ChargeAffectedUpTrggrCtrllr : UpTrggrCtrllr
{
    ...
    {
        return ability.itemBase.Detect(ref ability.affected, caster.container,pos , dir, (int)Mathf.Clamp(timePressed * triggerBase.multiplyTime, 1, ability.itemBase.FinalMaxDetects), minRange ?? FinalMinRange, maxRange ?? FinalMaxRange, dot ?? ability.itemBase.Dot);
    }
}