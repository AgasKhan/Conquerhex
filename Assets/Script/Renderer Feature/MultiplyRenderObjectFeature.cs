...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    public class MultiplyRenderObjectFeature : ScriptableRendererFeature
    {
        /// <summary>
        ...
        MultiplyRenderObjectPass renderObjectsPass;
        ...
        public override void Create()
        {
            ...
            renderObjectsPass = new MultiplyRenderObjectPass(settings.passTag, settings.Event, filter.PassNames,
