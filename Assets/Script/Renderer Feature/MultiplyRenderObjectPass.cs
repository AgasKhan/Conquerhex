...
namespace UnityEngine.Experimental.Rendering.Universal
{
    ...
    /// </summary>
    public class MultiplyRenderObjectPass : ScriptableRenderPass
    {
        ...
        public MultiplyRenderObjectPass(string profilerTag, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, MultiplyRenderObjectFeature.CustomCameraSettings cameraSettings)
        {
        ...
        internal MultiplyRenderObjectPass(URPProfileId profileId, RenderPassEvent renderPassEvent, string[] shaderTags, RenderQueueType renderQueueType, int layerMask, RenderObjects.CustomCameraSettings cameraSettings)
        ...
        {
            internal MultiplyRenderObjectPass pass;
